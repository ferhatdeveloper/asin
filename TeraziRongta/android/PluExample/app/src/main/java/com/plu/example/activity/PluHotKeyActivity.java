...
import com.plu.example.adapter.HotkeyListAdapter;
...
public class PluHotKeyActivity extends BaseActivity implements View.OnClickListener {

    private Button btn_refresh;
    private ListView lv_hotkey;
    private ProgressBar pb_loading;

    private List<HotKeybean> list = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plu_hot_key);
        initView();
        addListener();
        init();
    }
    ...
    public void initView() {
        lv_hotkey = findViewById(R.id.lv_hotkey);
    ...
    @Override
    public void init() {
        adapter = new HotkeyListAdapter(this, list);
        lv_hotkey.setAdapter(adapter);
    ...
    private void refreshData() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                ArrayList<HotKeybean> tempList = pluManage.getPluHotKey();
                Log.e("mao","tmplist.szie="+String.valueOf(  tempList.size()));
