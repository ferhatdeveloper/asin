-- PostgREST PGRST203: 063 (8 param) + 064 (9 param) aynı anda kalınca RPC seçilemiyor.
-- Yalnızca metadata destekli sürüm kalsın.

DROP FUNCTION IF EXISTS public.register_pos_terminal(
  TEXT, TEXT, UUID, TEXT, TEXT, TEXT, TEXT, TEXT
);

-- PostgREST: dönüş kolonları TEXT olmalı (status VARCHAR(20) → 42804)
