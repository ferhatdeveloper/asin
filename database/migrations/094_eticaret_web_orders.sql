-- Online mağaza web siparişleri + sipariş fişine dönüştürme (demo kapalıyken)
...
COMMENT ON TABLE public.eticaret_web_orders IS 'Online mağaza web siparişleri; demo kapalıyken rex_*_sales sipariş fişine dönüşür';

-- Web siparişi → sipariş fişi (trcode 20, fiche_type order)
...
COMMENT ON FUNCTION public.eticaret_submit_web_order(JSONB) IS
  'Online mağaza checkout — web sipariş kaydı; demo değilse rex_*_sales sipariş fişi (trcode 20)';
